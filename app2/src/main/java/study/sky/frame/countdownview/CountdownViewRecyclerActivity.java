package study.sky.frame.countdownview;
...
public class CountdownViewRecyclerActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_countdownview_recycler);
        ButterKnife.bind(this);
        tvTitle.setText("CountdownView");
        initData();

        recyclerView.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false));
        recyclerView.addItemDecoration(new DividerItemDecoration(this, DividerItemDecoration.VERTICAL));
        recyclerView.setAdapter(mMyAdapter = new MyAdapter(this, mDataList));
    }
    ...
    private void initData() {
        ...
        for (int i = 1; i < 20; i++) {
            mDataList.add(new ItemInfo(1000 + i, "RecyclerView_测试标题_" + i, i * 60 * 1000));
        }
